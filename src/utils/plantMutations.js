...
export const plantGroups = ["Apples","Pears","Plums","Cherries","Citrus","Peach / Stone Fruit","Figs","Other Fruit Trees","Mints","Sage","Herbs","Tomatoes","Vegetables","Berries and Vines","Flowers and Perennials","Houseplants and Container Plants","Other / Uncategorized"];
...
const exactTypeGroups = new Map([["apple","Apples"],["pear","Pears"],["plum","Plums"],["cherry","Cherries"],["peach","Peach / Stone Fruit"],["nectarine","Peach / Stone Fruit"],["apricot","Peach / Stone Fruit"],["fig","Figs"],["mint","Mints"],["sage","Sage"],["tomato","Tomatoes"],["rose","Flowers and Perennials"]]);
...
export function validateAndNormalizePlant(input, existingPlants=[], editingId=null) {
  ...
  ["nickname","variety","botanicalName","gardenZone","location","status","sun","water","plantingDate","acquisitionDate","source","notes","iconType"].forEach((field)=>{const value=String(input[field]||"").trim();if(value)record[field]=value;});
